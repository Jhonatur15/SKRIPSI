void fuzzyRule() {
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_S_1 = new FuzzyRuleConsequent();
  DO_S_1->addOutput(DO_S);
  // =====
  FuzzyRule *fuzzyRule22 = new FuzzyRule(22, LS_ZD, DO_S_1);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_S_2 = new FuzzyRuleConsequent();
  DO_S_2->addOutput(DO_S);
  // =====
  FuzzyRule *fuzzyRule23 = new FuzzyRule(23, LS_LD, DO_S_2);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_C_1 = new FuzzyRuleConsequent();
  DO_C_1->addOutput(DO_C);
  // =====
  FuzzyRule *fuzzyRule24 = new FuzzyRule(24, LS_MD, DO_C_1);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_B_1 = new FuzzyRuleConsequent();
  DO_B_1->addOutput(DO_B);
  // =====
  FuzzyRule *fuzzyRule25 = new FuzzyRule(25, LS_HD, DO_B_1);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_S_3 = new FuzzyRuleConsequent();
  DO_S_3->addOutput(DO_S);
  // =====
  FuzzyRule *fuzzyRule26 = new FuzzyRule(26, MS_ZD, DO_S_3);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_S_4 = new FuzzyRuleConsequent();
  DO_S_4->addOutput(DO_S);
  // =====
  FuzzyRule *fuzzyRule27 = new FuzzyRule(27, MS_LD, DO_S_4);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_C_2 = new FuzzyRuleConsequent();
  DO_C_2->addOutput(DO_C);
  // =====
  FuzzyRule *fuzzyRule28 = new FuzzyRule(28, MS_MD, DO_C_2);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_B_2 = new FuzzyRuleConsequent();
  DO_B_2->addOutput(DO_B);
  // =====
  FuzzyRule *fuzzyRule29 = new FuzzyRule(29, MS_HD, DO_B_2);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_S_5 = new FuzzyRuleConsequent();
  DO_S_5->addOutput(DO_S);
  // =====
  FuzzyRule *fuzzyRule30 = new FuzzyRule(30, HS_ZD, DO_S_5);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_C_3 = new FuzzyRuleConsequent();
  DO_C_3->addOutput(DO_C);
  // =====
  FuzzyRule *fuzzyRule31 = new FuzzyRule(31, HS_LD, DO_C_3);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_B_3 = new FuzzyRuleConsequent();
  DO_B_3->addOutput(DO_B);
  // =====
  FuzzyRule *fuzzyRule32 = new FuzzyRule(32, HS_MD, DO_B_3);
  ...
  // 2Rule
    FuzzyRuleConsequent *DO_B_4 = new FuzzyRuleConsequent();
  DO_B_4->addOutput(DO_B);
  // =====
  FuzzyRule *fuzzyRule33 = new FuzzyRule(33, HS_HD, DO_B_4);
